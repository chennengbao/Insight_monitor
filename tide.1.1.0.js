 ...
 * @Last Modified time: 2017-01-06 17:17:29
 *
 * @config 配置信息
 * @deviceInfo 设备信息
...
!function() {
    ...
    Domob.prototype.init = function(){
        ...
        this.addEvent(window, 'load', function() {
            setTimeout(function() {
                ...
                pagePerformanceData.dateTime = _this.getTimesTamp();
                _this.sendData(JSON.stringify(pagePerformanceData));  
            }, 5000);
            // 发送设备信息
            deviceInfo.dateTime = _this.getTimesTamp();
    ...
    Domob.prototype.createUvId = function() {
        ...
        deviceInfo.uvId = dataStorage.uvId;
    }
    ...
    Domob.prototype.getPerformanceTiming = function() {
        ...
        times.siteId = _setting_.siteId,
        times.uvId = dataStorage.uvId;
        // 网页加载完成的时间
